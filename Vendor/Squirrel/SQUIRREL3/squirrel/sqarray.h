...
public:
	...
	bool Get(const SQInteger nidx,SQObjectPtr &val) const {
	...
	SQInteger Next(const SQObjectPtr &refpos,SQObjectPtr &outkey,SQObjectPtr &outval) const {
